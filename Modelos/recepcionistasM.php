...
class RecepcionistasM extends ConexionBD{

    //Ingresar Recepcionista
    static public function  IngresarRecepcionistaM($tablaBD, $datosC){
    ...
    //Ver Perfil Recepcionista
    static public function VerPerfilRecepcionistaM($tablaBD, $id){
    ...
    static public function ActualizarPerfilRecepcionistaM($tablaBD,$datosC){

        $pdo = ConexionBD::cBD()->prepare("UPDATE $tablaBD SET usuario = :usuario, 
                                                               clave = :clave,
                                                               nombre = :nombre,
                                                               apellido = :apellido,
    ...
    static public function CrearRecepcionistaM($tablaBD,$datosC){
    ...
    static public function BorrarRecepcionistaM($tablaBD,$id){
