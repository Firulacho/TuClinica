...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <?php
            ...
            echo '<h1>Profesional: '.$resultado["apellido"].' '.$resultado["nombre"].'</h1>';
                    ...
                    <div class="box-body">
                        ...
                        <?php
                            ...
                            echo' <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-lg"name="nyaC" value="
                                        '.$_SESSION["nombre"].' '.$_SESSION["apellido"].'" readonly>

                                        <input type="hidden" name="Pid" value="'.$resultado["id"].'">
                                        <input type="hidden" name="PAid" value="'.$_SESSION["id"].'">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <h2>Rut: </h2>
                                        <input type="text" class="form-control input-lg" name="rutC" value="'.$_SESSION["rut"].'" readonly>
