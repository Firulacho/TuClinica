...
class AdminM extends ConexionBD{
    ...
    static public function IngresarAdminM($tablaBD, $datosC){
        ...
        $pdo = ConexionBD::cBD()->prepare("SELECT id, usuario, clave, nombre, apellido, foto, rol 
                                            FROM $tablaBD 
    ...
    static public function VerPerfilAdminM($tablaBD, $id){
        ...
        $pdo = ConexionBD::cBD()->prepare("SELECT id, usuario, clave, nombre, apellido, foto 
                                            FROM $tablaBD 
                                            WHERE id = :id");
    ...
    static public function ActualizarPerfilAdminM($tablaBD, $datosC){
        ...
        $pdo = ConexionBD::cBD()->prepare("UPDATE $tablaBD 
                                            SET usuario = :usuario, clave=:clave, nombre=:nombre, apellido = :apellido, foto=:foto
                                            WHERE id=:id");
